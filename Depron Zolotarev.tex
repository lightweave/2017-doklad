...
\begin{itemize}
	\item  0,304 мГр/ч за защитой  1,75 г см-2,  Foton M2
	 \item  2,314 мГр/ч за защитой   0,71 г см2, экранируя в Foton M3 
	 \item  19, 195 мГр/ч за защитой менее 0,4 г / см2 на МКС (поток составляет 8363 см-2*с-1) .
\end{itemize}
}
\end{column}
\begin{column}{.5\textwidth}
...
%			\vspace{0.5cm}
			...
			\pic [fill=gray, text=blue, draw=gray] at (6,-3.0) {annotated cuboid={width=60, height=15, depth=60, units=мм}};
...
\begin{column}{.5\textwidth}
	\begin{block}{}			
		...
		\begin{tabular}{|c|c|c|}
			...
			\hline 
			Электроны &  > 1 МэВ & > 1,5 МэВ \\ 
			\hline 
			Протоны & > 18 МэВ & > 23 МэВ \\ 
			\hline 
		\end{tabular} 
